...
describe('TasksListComponent', () => {
  ...
  it('debería actualizar la tarea en la matriz de tareas', () => {
    ...
    const mockTask = { id: '1', title: 'Tarea de prueba actualizada', description: 'Descripcion de tarea actualizada', createdAt: '23/01/2025 18:18:18', completed: false };
    component.tasks = [{ id: '1', title: 'Tarea de prueba', description: 'Descripcion de tarea', createdAt: '23/01/2025 18:18:18', completed: true }];
  ...
  it('debería eliminar la tarea de la lista de tareas', () => {
    const mockTask = { id: '1', title: 'Tarea de prueba', description: 'Descripcion de tarea', createdAt: '23/01/2025 18:18:18', completed: true };
